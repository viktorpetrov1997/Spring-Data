...
public class TestDbPrimaryKeys {
    ...
    void testPrimaryKeys() throws SQLException {
        ...
        ResultSet primaryKeyAstronomers = metaData.getPrimaryKeys(null, null, "DEALERS");
        ResultSet primaryKeyConstellations = metaData.getPrimaryKeys(null, null, "DEALERSHIPS");
        ResultSet primaryKeyStars = metaData.getPrimaryKeys(null, null, "CARS");
